...
public class TransactionDAO {
    ...
    /**
     * Obtiene la última transacción registrada para una cuenta.
     */
    public Transaction obtenerUltimaPorCuenta(int cuentaId) {
        String sql = "SELECT * FROM transacciones WHERE cuenta_origen_id = ? OR cuenta_destino_id = ? " +
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.err.println("Error al obtener última transacción: " + e.getMessage());
            e.printStackTrace();
        }
        return null;
    }

        ...
        try {
            ...
            if (exito) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    Transaction ultimaTransaccion = transactionDAO.obtenerUltimaPorCuenta(cuenta.getId());
                    
                    if (ultimaTransaccion != null) {
                        javax.swing.JFileChooser fileChooser = new javax.swing.JFileChooser();
                        fileChooser.setDialogTitle("Guardar Comprobante de Recarga");
                        String nombreArchivo = String.format("Comprobante_Recarga_%08d.pdf", ultimaTransaccion.getId());
                        ...
                        if (resultado == javax.swing.JFileChooser.APPROVE_OPTION) {
                            ...
                            boolean pdfExito = PDFExporter.exportarComprobante(ultimaTransaccion, cuenta, ruta);
                            if (pdfExito) {
                                try {

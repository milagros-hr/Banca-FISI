...
public class TransferPanel extends JPanel {
    ...
    private void ejecutarTransferencia() {
        try {
            ...
            if (exito) {
                // Preguntar si desea descargar comprobante
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    Transaction ultimaTransaccion = transactionDAO.obtenerUltimaPorCuenta(cuentaOrigen.getId());
                    
                    if (ultimaTransaccion != null) {
                        javax.swing.JFileChooser fileChooser = new javax.swing.JFileChooser();
                        fileChooser.setDialogTitle("Guardar Comprobante de Transferencia");
                        String nombreArchivo = String.format("Comprobante_Transferencia_%08d.pdf", ultimaTransaccion.getId());
                        ...
                        if (resultado == javax.swing.JFileChooser.APPROVE_OPTION) {
                            ...
                            boolean pdfExito = PDFExporter.exportarComprobante(ultimaTransaccion, cuentaOrigen, ruta);
                            if (pdfExito) {
                                try {
